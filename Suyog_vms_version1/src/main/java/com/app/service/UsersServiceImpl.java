...
public class UsersServiceImpl implements UsersService {
    ...
    public void deleteUser(Long userId) {
        ...
        userOptional.ifPresent(user -> {
            List<CarBooking> bookings = user.getBooking();
            carBookingRepository.deleteAll(bookings); // Delete associated car bookings
            usersRepository.delete(user); // Delete the user
        });
    }
